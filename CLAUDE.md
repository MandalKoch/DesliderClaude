...
- [ ] **Donate button** in the footer (Ko-fi / Buy-Me-a-Coffee / GitHub Sponsors link). Covers hosting + signals "this is hobby, not commercial" which keeps the BGG API use and the game-image hotlinking on solid ground.
